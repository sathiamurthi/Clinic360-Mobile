...
const styles = StyleSheet.create({
  ...
  tokenBadge: { backgroundColor: '#CCFBF1', width: 45, height: 45, borderRadius: 22.5, justifyContent: 'center', alignItems: 'center' },
  tokenText: { fontSize: 16, fontWeight: 'bold', color: '#0F766E' },
